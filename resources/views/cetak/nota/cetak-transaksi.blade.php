...
@if($jenis === 'peminjaman')
    ...
    <div class="card">
        ...
        <div class="header">
            <div class="logo">
                <img src="{{ public_path('img/logo.png') }}" alt="Logo Perpustakaan">
            </div>
        </div>
            ...
            <div class="row">
                ...
                <span>
                    {{ $transaction->tanggal_jatuh_tempo 
                        ? \Carbon\Carbon::parse($transaction->tanggal_jatuh_tempo)->format('d-m-Y') 
                        : '-' 
                    }}
                </span>
            </div>
        ...
        <!-- NOTE -->
        <div class="note">
            <img src="{{ public_path('img/logo.png') }}" alt="Icon">
            <p>
