...
<header class="header">
    <div class="container">
        <nav class="navbar">
            <div class="logo">
                <img src="{{ asset('img/logo_smk4.png') }}" alt="SMKN 4 Bojonegoro" class="logo-img">
...
<section class="hero" id="home">
            ...
            <div class="hero-text">
                <h2 class="hero-title">
                    <div class="hero-logo-container">
                        <img src="{{ asset('img/logo_smk4.png') }}" alt="SMKN 4 Bojonegoro" class="hero-logo">
                        <span class="school-name">Perpustakaan Digital</span>
                    </div>
                </h2>
   ...
   <!-- Layanan Perpustakaan - 4 Cards + Icon Dekat -->
<section class="services" id="services">
    <div class="container">
        <div class="section-header">
            <h2><i class="fas fa-book"></i> Layanan Perpustakaan </h2>
        ...
        <div class="services-grid">
            <div class="service-card">
                ...
                <p>Layanan peminjaman buku bagi anggota perpustakaan untuk mendukung kegiatan belajar, tugas sekolah, dan pengembangan wawasan sesuai peraturan.</p>
            </div>
            <div class="service-card">
                <div class="service-icon">
                ...
                <p>Layanan pengembalian buku yang dilakukan secara tertib dan tepat waktu guna menjaga ketersediaan koleksi serta kedisiplinan anggota.</p>
            </div>
            <div class="service-card">
                <div class="service-icon">
                ...
                <p>Pengelolaan koleksi buku meliputi pendataan, pengelompokan, pemeliharaan, serta pembaruan data buku secara berkala oleh petugas profesional.</p>
            </div>
            <div class="service-card">
                <div class="service-icon">
                ...
                <p>Layanan kunjungan sebagai sarana membaca, belajar mandiri, diskusi kelompok, dan meningkatkan minat literasi di lingkungan sekolah.</p>
            </div>
        </div>
    </div>
</section>
     ...
     <!-- Register Section -->
   <section class="literasi-registration">
     <div class="section-header">
                <h2><i class="fas fa-user-plus"></i> Bergabung dengan Perpustakaan</h2>
                <p>Daftar sebagai anggota dan nikmati semua layanan perpustakaan digital kami secara gratis dan mudah.</p>
            </div>
    <div class="container registration-wrapper">
        <div class="reg-content">
            ...
            <div class="info-cards">
                <div class="info-item">
                    ...
                    <div class="info-text">
                        <h4>Pinjam Buku</h4>
                        <p>Hingga 6 buku sekaligus</p>
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-icon"><i class="fas fa-calendar-alt"></i></div>
                    <div class="info-text">
                        <h4>Masa Pinjam 2 Hari</h4>
                        <p>Bisa diperpanjang via aplikasi</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-text">
                        <h4>Akses Digital</h4>
                        <p>E-book & Jurnal online 24/7</p>
                    </div>
                </div>
            </div>

            <a href="{{ route('registerAnggota.show') }}" class="btn-card btn-glow">
                <i class="fas fa-book"></i> Daftar sebagai Anggota <i class="fas fa-arrow-right icon-move"></i>
            </a>
        </div>
        ...
        <div class="reg-visual">
            ...
            <i class="fas fa-book floating-icon book-1"></i>
            <i class="fas fa-search floating-icon search-1"></i>
            <i class="fas fa-sparkles floating-icon star-1"></i>
        </div>
    ...
    <div class="container">
        <div class="main-header-wrapper">
            ...
            <h1 class="hero-title-large">
                <span class="highlight-text">SMKN 4 Bojonegoro</span>
            </h1>
        </div>
        ...
        <div class="about-grid">
            <div class="image-collage">
                <div class="img-wrapper">
                    <img src="{{ asset('img/logo.png') }}" alt="Kegiatan Siswa">
                </div>
            </div>

            <div class="about-info">
                <p class="description">
                    SMKN 4 Bojonegoro adalah sekolah menengah kejuruan yang berfokus pada pengembangan kompetensi 
                    siswa agar siap memasuki dunia kerja, berwirausaha, dan melanjutkan pendidikan ke jenjang 
                    yang lebih tinggi dengan dukungan fasilitas modern.
                </p>
                ...
                <div class="feature-list">
                    <div class="feature-item">
                        ...
                        <div class="feature-text">
                            ...
                            <p>Kurikulum berbasis industri dan magang berkualitas.</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-text">
                            <h4>Wirausaha Muda</h4>
                            <p>Membentuk mental mandiri dan kreatif sejak dini.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="logo-sidebar">
                <div class="glass-card">
                    <div class="badge-literasi">Sekolah Literasi</div>
                    <img src="{{ asset('img/logo_smk4.png') }}" class="school-logo" alt="Logo SMKN 4">
                    
                    <div class="mini-card-yellow">
                        <i class="fas fa-certificate"></i>
                        <div>
                            <h5>Terakreditasi A</h5>
                            <p>Kualitas pendidikan standar nasional.</p>
                        </div>
                    </div>
                </div>
            </div>
